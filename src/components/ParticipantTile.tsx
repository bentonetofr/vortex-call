...
export function ParticipantTile({ name, color, videoStream, micEnabled, isScreen, muted }: ParticipantTileProps) {
  ...
  return (
    <div className="relative flex aspect-video items-center justify-center overflow-hidden rounded-lg bg-vc-sidebar">
      {videoStream ? (
